...
class PacientesListForDelete extends StatefulWidget {
  const PacientesListForDelete({super.key});

  @override
  State<PacientesListForDelete> createState() => _PacientesListForDeleteState();
}

class _PacientesListForDeleteState extends State<PacientesListForDelete> {
